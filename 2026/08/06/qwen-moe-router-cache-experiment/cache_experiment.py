"""
対照実験本体（条件A: 素のgenerateベースライン vs 条件B: 観測ベースの事前ウォームアップ）

2026-08-06にM1 Max 64GBで実測済み。結果と考察は記事を参照:
https://www.lilting.ch/articles/qwen-moe-router-cache-experiment
